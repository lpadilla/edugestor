<?php
    ...
    $img_class = 'col-md-3 icon-service al-bg-mask background-image';
    $content_class = 'col-md-9 content-service';
    $article_class = 'item-service item-full-height';
...
<article class="<?php echo esc_attr($article_class); ?>">
    ...
    <div class="<?php echo esc_attr($content_class); ?>">
        ...
        <div class="buttons-section left">
            <a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>" class="btn white-btn"><?php echo esc_html('Get started', 'bober'); ?></a>
        </div>
    </div>
</article>